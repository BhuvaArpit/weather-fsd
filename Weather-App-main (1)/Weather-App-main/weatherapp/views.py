...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=8c352d3ae5487b0a5301870e344bb64b'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyCfOeRxxYqLVh2m1bnpS1bbsRYaqSfKtsM'

    SEARCH_ENGINE_ID = 'c170b97de3f644e6e'
